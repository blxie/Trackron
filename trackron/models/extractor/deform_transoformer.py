...
class DeformableTransformer(nn.Module):
    ...
    def forward(self,
        ...
        if pre_reference is not None:
            ...
            query_embed = None
            # decoder
            hs, inter_references = self.decoder_track(tgt, reference_points,
            ...
            if self.two_stage:
                ...
                topk_proposals = torch.topk(enc_outputs_class[..., 0],
                                            topk,
                                            dim=1)[1]
