...
from trackron.engine import default_writers
from trackron.checkpoint import TrackingCheckpointer
...
from trackron.utils.env import TORCH_VERSION, seed_all_rng
from torch.nn.parallel import DistributedDataParallel
from trackron.utils.logger import setup_logger
from fvcore.nn.precise_bn import get_bn_modules
from .train_loop import TrainerBase, SimpleTrainer, AMPTrainer
from . import hooks
...
class DefaultTrainer(TrainerBase):
    ...
    It is only guaranteed to work well with the standard models and training workflow in Tracker.
