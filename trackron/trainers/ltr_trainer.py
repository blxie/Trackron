...
from trackron.admin.stats import AverageMeter, StatValue
from trackron.admin.tensorboard import TensorboardWriter
...
class LTRTrainer(DefaultTrainer):
    ...
    def cycle_dataset(self, loader):
        ...
        self.objective.train(loader.training)
        ...
        for i, data in enumerate(loader, 1):
            ...
            # forward pass
            loss, stats = self.objective(data)
            ...
            # update statistics
            if isinstance(data['template_images'], (list, tuple)):
                batch_size = data['template_images'][0].shape[loader.stack_dim]
            else:
